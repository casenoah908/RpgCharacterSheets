...
import { RaceTrait } from '../../Objects/raceTrait';
    ...
    let name: string = "Wood Elf";
    let abilityScoreIncrease: Array<number> = [0, 2, 0, 0, 1, 0];
    ...
    let speed: number = 35;
    let languages: Array<string> = ["Common", "Elvish"];
    ...
    let traits: Array<RaceTrait> = [{ header: "Darkvision", description: "Accustomed to twilit forests and the night sky, you have superior vision in dark and dim Conditions. You can see in dim light within 60 feet of you as if it were bright light, and in Darkness as if it were dim light. You can’t discern color in Darkness, only Shades of Gray." },
        ...
        { header: "Mask of the Wild", description: "You can attempt to hide even when you are only lightly obscured by foliage, heavy rain, falling snow, mist, and other natural phenomena."}
    ];
