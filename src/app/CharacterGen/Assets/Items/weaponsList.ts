...
export const WeaponsList: Weapon[] = [
    ...
    {name: 'Greatsword', classification: 'martial weapon', price: '50 gp', damageType: 'slashing', damageDie: [6,6], weight: 6, bonusType: ['strength'], properties: ['Heavy','Two-Handed']},
    ...
    {name: 'Longsword', classification: 'martial weapon', price: '15 gp', damageType: 'slashing',  damageDie: [8], weight: 3, bonusType: ['strength'], properties: ['Versatile (1d10)']},
    ...
    {name: 'Shortsword', classification: 'martial weapon', price: '10 gp', damageType: 'piercing', damageDie: [6], weight: 2, bonusType: ['strength','dexterity'], properties: ['Finesse','Light']},
    ...
    {name: 'Warpick', classification: 'martial weapon', price: '5 gp', damageType: 'piercing', damageDie: [8], weight: 2, bonusType: ['strength'], properties: []},
    {name: 'Warhammer', classification: 'martial weapon', price: '15 gp', damageType: 'bludgeoning', damageDie: [8], weight: 2, bonusType: ['strength'], properties: ['Versatile (1d10)']},
