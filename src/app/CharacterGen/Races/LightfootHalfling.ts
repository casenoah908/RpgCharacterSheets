...
import { RaceTrait } from '../raceTrait';
    ...
    let name: string = "Lightfoot Halfling";
    let abilityScoreIncrease: Array<number> = [0, 2, 0, 0, 0, 1];
    ...
    let traits: Array<RaceTrait> = [{ header: "Lucky", description: "When you roll a 1 on the d20 for an attack roll, ability check, or saving throw, you can reroll the die and must use the new roll." },
        ...
        { header: "Naturally Stealthy", description: "You can attempt to hide even when you are obscured only by a creature that is at least one size larger than you."}
    ];
